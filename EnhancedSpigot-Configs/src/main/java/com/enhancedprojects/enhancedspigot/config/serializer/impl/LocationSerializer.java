...
public class LocationSerializer implements ISerializer<Location> {
	...
	public Location deserialize(Object serialized, Class<? extends Location> targetClass, EnhancedConfig config) {
		...
		return new Location(
			Bukkit.getWorld(section.getString("world")), section.getDouble("x"), section.getDouble("y"), section.getDouble("z"), (float) section.getDouble("yaw"), (float) section.getDouble("pitch"));
	}
