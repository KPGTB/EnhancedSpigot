...
package com.enhancedprojects.enhancedspigot.data.persister.base;

import com.enhancedprojects.enhancedspigot.data.util.CollectionUtil;
import com.enhancedprojects.enhancedspigot.util.gson.GsonAdapterRegistry;
...
public class MapPersister extends LongStringType {
	...
	public Object javaToSqlArg(FieldType fieldType, Object javaObject) throws SQLException {
		...
		if (!map.isEmpty()) {
			keyClazz = map.keySet()
				.toArray()[0].getClass()
				.getName();
			valueClazz = CollectionUtil.getObjectTypes(map.values()
				.toArray()[0]);
		}

		String mapJson = GsonAdapterRegistry.getInstance()
			.getGson()
			.toJson(map);
	...
	public Object sqlArgToJava(FieldType fieldType, Object sqlArg, int columnPos) throws SQLException {
		...
		try {
			...
			Type mapType = TypeToken.getParameterized(Map.class, keyType, valueType)
				.getType();
