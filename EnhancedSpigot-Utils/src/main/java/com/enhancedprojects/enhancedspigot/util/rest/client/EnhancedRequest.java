...
package com.enhancedprojects.enhancedspigot.util.rest.client;
...
@Builder public class EnhancedRequest {
	private String url;
	...
	public EnhancedResponse send() throws IOException {
		...
		TryCatchUtil.tryRun(
			() -> connection.setRequestMethod(this.method.name()), (e) -> {
		...
		if (!this.cookies.isEmpty()) {
			...
			this.headers.putIfAbsent(
				"Cookie", cookieManager.getCookieStore()
					.getCookies()
					.stream()
