...
package com.enhancedprojects.enhancedspigot.menu.nms;
...
public class InventoryHelper_1_19_3 implements IInventoryHelper {
	@Override
	public void updateInventoryTitle(Player player, String title) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException, InstantiationException {
		...
		Object entityPlayer = getCraftBukkitClass("entity.CraftPlayer").getMethod("getHandle")
			.invoke(player);
		...
		Object chatMessage = getNMClass("network.chat.IChatBaseComponent").getMethod("a", String.class)
			.invoke(getNMClass("network.chat.IChatBaseComponent"), title);

		Object packet = getNMClass("network.protocol.game.PacketPlayOutOpenWindow").getDeclaredConstructor(
				int.class, getNMClass("world.inventory.Containers"),
				getNMClass("network.chat.IChatBaseComponent")
			)
