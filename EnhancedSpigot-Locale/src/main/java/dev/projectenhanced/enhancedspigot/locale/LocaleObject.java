...
public class LocaleObject {
    ...
    public Object toConfig() {
        return this.rawText.size() == 1 ? this.rawText.get(0) : this.rawText;
    }
    ...
    public void to(CommandSender sender, SendType type, TagResolver... placeholders) {
        ...
        switch (type) {
            ...
            case ACTIONBAR:
                ...
                break;
            case TITLE:
                this.bridge.sendTitle((Player) sender, components.get(0), components.size() > 1 ? components.get(1) : Component.text(""));
                break;
        }
    }
