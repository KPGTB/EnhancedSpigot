...
public class CommandLocale {
	...
	@LocaleDefault(language = "en", def = "<dark_green><st>┌─────┤</st> /<green><command> <dark_green>- <blue>Help page")
	@LocaleDefault(language = "pl", def = "<dark_green><st>┌─────┤</st> /<green><command> <dark_green>- <blue>Pomoc")
	LocaleObject helpStart;
	@LocaleDefault(language = "en", def = "<dark_green><st>├─</st> <red>There isn't any help for you.")
	@LocaleDefault(language = "pl", def = "<dark_green><st>├─</st> <red>Brak pomocy")
	LocaleObject helpNoInfo;
	@LocaleDefault(language = "en", def = "<dark_green><st>├─</st> <green><command> <dark_green>- <aqua><description>")
	@LocaleDefault(language = "pl", def = "<dark_green><st>├─</st> <green><command> <dark_green>- <aqua><description>")
